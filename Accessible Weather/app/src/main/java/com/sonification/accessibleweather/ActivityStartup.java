...
public class ActivityStartup extends Activity
{
	...
	public void loadSplashScreen()
	{
        ...
        Log.e("Startup", "Registering for location updates");
    ...
    private BroadcastReceiver mMessageReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Log.e("Intent_Service", "Received Message: " + certainty + ", " + latitude + ", " + longitude);
            ...
            if (latitude.equals("0") && longitude.equals("0")) {
                ...
                if (certainty == LocationFetcher.CONFIDENT) {
                    ...
                    loadingText.setText(getResources().getText(R.string.gettingLocationTakingLong));
                }
            }
            else {
                if (!mainStarted) {
                    // Start the main activity if it is not running already
                    Log.e("Startup", "Starting loadData with certainty " + certainty);
