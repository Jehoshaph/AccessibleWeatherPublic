...
public class ActivityStartup extends Activity
{
    ...
    private void getLocationUpdate()
    {
        ...
        if(attemptNumber == 0 && locationManager.isProviderEnabled(LocationManager.NETWORK_PROVIDER))
        {
            // Use network based coarse location
            providerName = LocationManager.NETWORK_PROVIDER;
        }
        else if(attemptNumber == 1 && locationManager.isProviderEnabled(LocationManager.GPS_PROVIDER))
        {
            providerName = LocationManager.GPS_PROVIDER;
        }
        else if(attemptNumber == 2 && locationManager.isProviderEnabled(LocationManager.PASSIVE_PROVIDER))
        {
