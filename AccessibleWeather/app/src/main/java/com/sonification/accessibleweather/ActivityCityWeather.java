...
public class ActivityCityWeather extends Activity
{
    ...
    private boolean parseCurrentString(String response)
    {
        try
        {
            ...
            hours = Integer.parseInt(tzStr.substring(4, 6));
            minutes = Integer.parseInt(tzStr.substring(7, 9));
            symbol = tzStr.substring(3, 4);
            ...
            cityTimeString = cal.getDisplayName(Calendar.DAY_OF_WEEK, Calendar.LONG, Locale.ENGLISH);

            SimpleDateFormat simpleDateFormat = new SimpleDateFormat("HH:mm aa");

            cityTimeString = cityTimeString + " " + simpleDateFormat.format(cal.getTime());
